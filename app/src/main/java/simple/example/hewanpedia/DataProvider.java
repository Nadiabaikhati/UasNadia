...
public class DataProvider {
    ...
    private static Collection<? extends Hewan> Kelinci;
    ...
    private static List<Kucing> initDataKucing(Context ctx) {
        ...
        kucings.add(new Kucing(ctx.getString(R.string.bengal_nama), ctx.getString(R.string.angora_asal),
                ctx.getString(R.string.angora_deskripsi), R.drawable.cat_bengal));
        kucings.add(new Kucing(ctx.getString(R.string.birmani_nama),ctx.getString(R.string.birmani_asal),
                ctx.getString(R.string.angora_deskripsi), R.drawable.cat_birman));
        kucings.add(new Kucing(ctx.getString(R.string.persia_nama), ctx.getString(R.string.persia_asal),
                ctx.getString(R.string.angora_deskripsi), R.drawable.cat_persia));
    ...
    private static Collection<? extends Hewan> initDataKelinci(Context ctx) {
        ...
        kelincis.add(new Kelinci(ctx.getString(R.string.Kelinci_Anggora_nama), ctx.getString(R.string.kelinci_Anggora_asal),
                ctx.getString(R.string.Kelinci_Anggora_deskripsi), R.drawable.kelinci3));
        kelincis.add(new Kelinci(ctx.getString(R.string.Kelinci_Rex_nama), ctx.getString(R.string.Kelinci_Rex_asal),
                ctx.getString(R.string.Kelinci_Rex_deskripsi),R.drawable.jenis_kelinci_3));
        kelincis.add(new Kelinci(ctx.getString(R.string.Kelinci_Himalaya_nama), ctx.getString(R.string.Kelinci_Himalayan_asal),
                ctx.getString(R.string.Kelinci_Himalaya_deskripsi), R.drawable.jenis_kelinci_12));
        return Kelinci;
    }
